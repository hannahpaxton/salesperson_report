...
"""Original script commented out above - dictionary solution following"""
...
for line in f:
    ...
    if salesperson in sales_dictionary:
        sales_dictionary[salesperson] += melons
    else:
        sales_dictionary[salesperson] = melons

for salesperson, melons in sales_dictionary.items():
